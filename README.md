...
If you want to use it, you're supposed to make several copies of this script - one for your every device. I've considered automatically building for several APs, but I don't have any good reasons to implement it right now.
